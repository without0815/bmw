    ...
    loadClass : function(href, cls, member){
        ...
        if(tab){
            ...
            var p = this.add(new DocPanel({
                ...
                frame:true,
                //autoLoad: autoLoad,
                html:'<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src='+autoLoad.url+'></iframe>',
...
/*Ext.app.SearchField = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    onTrigger2Click : function(){
		...
		if(v.length < 2){
			Ext.Msg.alert('Invalid Search', 'You must enter a minimum of 2 characters to search the help');
			return;
		}
